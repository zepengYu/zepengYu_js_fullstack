    ...
    <div>
        <head-top>
            <router-link to="/search/geohash" class="link_search" slot="search">
                ...
                x-invalid-namespace="http://www.w3.org/2000/svg" >
        ...
        <nav class="msite_nav">
            <div class="swiper-container" v-if="foodTypes.length">
                <div class="swiper-wrapper">
                    <div class="swiper-slide food_types_container" v-for="(item, index) in foodTypes" :key="index">
                        ...
                        :to="{path:'/food',query:{geohash,title:foodItem.title,restraurant_category_id:foodItem.link}}" class="link_to_food">
                                <figure>
            ...
            <img src="../assets/fl.svg" alt="" v-else class="fl_back animation_opacity">
        </nav>
    </div>    
</template>
<script>
